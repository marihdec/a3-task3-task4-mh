...
urchins_summary %>%
  kable(col.names = c("Species", # rename table headings in order of appearance
                      ...
                      "Sample Size"),
        caption = "Table 1: A summary of urchin sizes showing the mean and median size, standard deviation in size, and sample size of each type of urchin that was studied.") # add table caption
```
